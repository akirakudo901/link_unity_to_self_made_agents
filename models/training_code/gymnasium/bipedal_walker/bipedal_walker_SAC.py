...
#     name = "no_clipping_256"
#     train_SAC_on_gym(parameters=p, parameter_name=name, 
#                      env=env, trainer=trainer, training_id=None)

# JUST TRAIN ONE PARAMETER
train_SAC_on_gym(parameters=parameters["policy_learning_rate_1e-3_without_clipping"], parameter_name="policy_learning_rate_1e-3_without_clipping", 
                 env=env, trainer=trainer, training_id=None)