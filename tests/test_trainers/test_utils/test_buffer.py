...
from trainers.utils.buffer import ListBuffer
...
class TestListBuffer(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.buffer = ListBuffer(max_size=self.MAX_SIZE, obs_shape=self.OBS_SHAPE, act_shape=self.ACT_SHAPE)
    ...
    def test_extend_buffer(self):
        ...
        buffer2 = ListBuffer(max_size=self.MAX_SIZE, obs_shape=self.OBS_SHAPE, act_shape=self.ACT_SHAPE)
